...
static void Encrypt(Fq *c,const small *r,const Fq *h)
{
  ...
  {
        FILE *d1_d2_data_file_txt = fopen("d1_d2_data.txt", "a");
       
        if (d1_d2_data_file_txt == NULL) {
            perror("Failed to open file");
            if (d1_d2_data_file_txt != NULL) fclose(d1_d2_data_file_txt);
            return;
        }
      ...
      for(int we1 = 0; we1 < n; we1++)
      {
        ...
        //printf("Index of g1: %d\n", index);
        x_g_array[index] = 1;
        non_zero_g_coeff = index;
        index_array[we1] = index;  
      }
      ...
      // { 
        ...
        fprintf(d1_d2_data_file_txt, "pq_counter: %d", pq_counter);
        fprintf(d1_d2_data_file_txt, "\nindex_array of x_f_array_copy : ");
        for (int i = 0; i < m; i++) {
            fprintf(d1_d2_data_file_txt, "%d,", index_array_f[i]);
        }
    
        fprintf(d1_d2_data_file_txt, "\nx_f_array_copy: ");
        for (int i = 0; i < p; i++)
        {
            fprintf(d1_d2_data_file_txt, "%d,", x_f_array_copy[i]);
        }

        // 输出index_array
        fprintf(d1_d2_data_file_txt, "\nindex_array of x_g_array_copy : ");
        for (int i = 0; i < n; i++) {
            fprintf(d1_d2_data_file_txt, "%d,", index_array[i]);
        }
        fprintf(d1_d2_data_file_txt, "\nx_g_array_copy: ");
        for (int i = 0; i < p; i++)
        {
            fprintf(d1_d2_data_file_txt, "%d,", x_g_array_copy[i]);
        }
        fprintf(d1_d2_data_file_txt, "\nglobal_g: ");
        for (int i = 0; i < p; i++)
        {
            fprintf(d1_d2_data_file_txt, "%d,", global_g[i]);
        }
...
static void Decrypt(small *r,const Fq *c,const small *f,const small *ginv)
{
  ...
  // printf("In kem_mod.c the e is...\n");
  for(i = 0; i < p; i++)
  {
    er_decrypt[i] = e[i];
    // printf("%d, ", er_decrypt[i]);
  }
  // printf("\n");
